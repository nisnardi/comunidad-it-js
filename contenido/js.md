...
bienvenido('Coco'); // Bienvenido Coco
saludar('Jarro');  // error, no esta definida la función saludar
```

* En este ejemplo podemos ver varias cosas
* Por un lado podemos tener funciones dentro de otra funcion
* Las funciones declaradas dentro de una función sólo se pueden llamar dentro de la función padre
